  ...
  <div class="subtitle-menu-outer">
    <ul class="subtitle-menu subtitle-main-menu" style="display:none">
      ...
      <?php foreach ($subtitleSettings as $settingKey => $setting): ?>
        <li data-setting="<?php print $settingKey ?>"><a href="javascript:void()"><?php print $setting['label'] ?> <img class="subtitle-menu-arrow" style="height:15px" src="<?php print get_template_directory_uri () ?>/frontend/img/right_arrow.png"/></a></li>
      <?php endforeach ?>
    </ul>
    <?php foreach ($subtitleSettings as $settingKey => $setting): ?>
      <ul class="subtitle-menu subtitle-submenu subtitle-submenu-<?php print $settingKey ?>" data-setting="<?php print $settingKey ?>" style="display:none">
        <li class="back"><a href="javascript:void()"><img class="subtitle-menu-arrow" style="height:15px" src="<?php print get_template_directory_uri () ?>/frontend/img/left_arrow.png"/> <?php print $setting['label'] ?></a></li>
