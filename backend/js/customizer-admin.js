...
Color.prototype.toString = function(remove_alpha) {
  ...
  $('.mpat-color-control').each(function() {
	var $control = $(this),
	...
	$('<div class="mpat-alpha-container"><div class="slider-alpha"></div><div class="transparency"></div></div>').appendTo($control.parents('.wp-picker-container'));
